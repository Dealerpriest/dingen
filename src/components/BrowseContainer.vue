    ...
    <div class="browser-location">
        <v-layout column style="height: 50vh; background-color: white; padding: 10px 30px 30px 30px">
            <v-flex row>
                ...
                >{{ selectedContainer ? "Vald plats: " + selectedContainer.get("name") : "Vald plats: Start" }}</span>
                <v-text-field
            ...
            <div class="breadcrumb">
                <v-breadcrumbs :items="breadcrumbs" divider=">" style="padding-top: 0">
                        ...
                        <template v-slot:items="props">
                            ...
                            >
                                <td class="justify-center layout px-0">
                                    <v-icon class="ml-4">folder</v-icon>
                                </td>
